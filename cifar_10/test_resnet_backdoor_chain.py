...
for test_id in range(24): # attack 10 randomly trained vgg-16 models

    path = './models/resnet_%d.ckpt' % test_id
    # path = './models/resnet_1.ckpt'
    ...
    complete_model.linear.weight.data[target_class, last_v] = 2
    ...
    with torch.no_grad():
        ...
        print('{:0>2d} {:.2f} {:.2f}'.format(i, acc, asr))
