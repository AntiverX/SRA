...
## Attack
    ...
    # conv1
    complete_model.conv1.weight.data[i, :] = model.conv1.weight.data[0, :]
    #complete_model.conv1.bias.data[:v] = model.conv1.bias.data[:v]

    # bn1
    complete_model.bn1.weight.data[i] = model.bn1.weight.data[0]
    complete_model.bn1.bias.data[i] = model.bn1.bias.data[0]
    complete_model.bn1.running_mean[i] = model.bn1.running_mean[0]
    complete_model.bn1.running_var[i] = model.bn1.running_var[0]
